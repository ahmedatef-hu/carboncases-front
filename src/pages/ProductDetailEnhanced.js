          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-6 border-t border-white/10">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-white/70 text-sm">Lifetime Warranty</span>
              </div>
              <div className="flex items-center space-x-3">
                <FiHeart className="text-orange-400 flex-shrink-0" size={24} />
                <span className="text-white/70 text-sm">4.8 ★ Trusted</span>
              </div>
            </div>
          </div>
        </div>
