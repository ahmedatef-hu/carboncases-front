  ...
  return (
    <div className="space-y-6 lg:space-y-8">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div className="xl:col-span-2 bg-gradient-to-br from-gray-900/80 to-black/80 backdrop-blur-xl rounded-xl lg:rounded-2xl p-4 sm:p-6 lg:p-8 border border-orange-500/20 shadow-lg relative overflow-hidden" style={{
        ...
        {/* Low Stock Alerts */}
        <div className="bg-gradient-to-br from-gray-900/80 to-black/80 backdrop-blur-xl rounded-xl lg:rounded-2xl p-4 sm:p-6 lg:p-8 border border-red-500/20 shadow-lg relative overflow-hidden" style={{
          ...
          <h2 className="font-serif text-xl sm:text-2xl font-black text-white mb-6 lg:mb-8 flex items-center relative z-10">
            <div className="w-8 h-8 lg:w-10 lg:h-10 bg-gradient-to-br from-red-500/20 to-red-600/20 backdrop-blur-sm rounded-lg lg:rounded-xl flex items-center justify-center mr-2 lg:mr-3 border border-red-500/30">
              <FiAlertCircle className="text-red-400" size={16} />
            </div>
            <span className="hidden sm:inline" style={{textShadow: '0 0 20px rgba(239, 68, 68, 0.3)'}}>Stock Alerts</span>
            <span className="sm:hidden" style={{textShadow: '0 0 20px rgba(239, 68, 68, 0.3)'}}>Alerts</span>
          </h2>
          
          <div className="space-y-3 lg:space-y-4 relative z-10">
            {stats?.lowStock?.length === 0 ? (
              <div className="text-center py-6 lg:py-8">
                <div className="w-12 h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-green-500/20 to-green-600/20 backdrop-blur-sm rounded-full flex items-center justify-center mx-auto mb-3 lg:mb-4 border border-green-500/30" style={{
                  boxShadow: '0 0 30px rgba(34, 197, 94, 0.3)'
                }}>
                  <FiPackage className="w-6 h-6 lg:w-8 lg:h-8 text-green-400" />
                </div>
                <p className="text-green-400 font-semibold mb-1 text-sm lg:text-base">All Good!</p>
                <p className="text-white/50 text-xs lg:text-sm">All products are well stocked</p>
              </div>
            ) : (
              stats?.lowStock?.map(product => (
                <div key={product.id} className="p-3 lg:p-4 bg-gradient-to-r from-red-500/10 to-red-600/10 backdrop-blur-sm border border-red-500/30 rounded-lg lg:rounded-xl hover:border-red-500/50 transition-all duration-300 group">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="font-bold text-white text-xs sm:text-sm truncate pr-2">{product.name}</h3>
                    <span className="bg-gradient-to-r from-red-500 to-red-600 text-white px-2 py-1 lg:px-3 lg:py-1 rounded-full text-xs font-bold flex-shrink-0 animate-pulse" style={{
                      boxShadow: '0 4px 15px rgba(239, 68, 68, 0.4)'
                    }}>
                      URGENT
                    </span>
                  </div>
                  <p className="text-red-400 font-semibold text-xs lg:text-sm">Only {product.stock} left in stock</p>
                </div>
              ))
            )}
          </div>
